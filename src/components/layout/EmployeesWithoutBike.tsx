                ...
                <CardHeader className="pb-3 border-b border-gray-100">
                    ...
                    <CardDescription className="text-base text-gray-500">
                        ...
                        <span className="text-yellow-600 inline-flex items-center ml-1">
                            ...
                            Funcionários sem motocicleta cadastrada ficarão indisponíveis para novas solicitações até regularizarem essa pendência no sistema.
                        </span>
                    </CardDescription>
                        ...
                        <div className="space-y-3">
                            {employeesWithoutMotorcycles.length > 0 ? (
                                ...
                                <p className="text-base text-gray-500 text-center py-4">
                                    Todos os mototaxistas têm motocicletas cadastradas
                                </p>
                            )}
                        </div>
                    )}
