...
export default function DailyBilling() {
  const BASE_URL = import.meta.env.VITE_API_BASE_URL || "http://192.168.0.12:3000";
    ...
    <div className="max-w-full mx-auto p-6 bg-white rounded-xl shadow-md border border-gray-100 space-y-6">
      ...
      <header className="flex justify-between items-center">
        ...
        <button
          ...
          disabled={loading}
          className={`p-2 rounded-md text-gray-700 hover:bg-gray-100 transition-colors flex items-center gap-2 ${
